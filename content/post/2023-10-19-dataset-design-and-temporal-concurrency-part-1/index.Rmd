...
dir(ifelse(Sys.getenv('GIT_REPOS') == '', Sys.getenv('GIT_Imperial'), Sys.getenv('GIT_REPOS')), pattern = "((jav.+help)|(blog_footer)).+R$)", recursive = TRUE, full.names = TRUE) |> walk(source);
...
- _Part 1_ will cover [Who?]{.speech} and [When?]{.speech}
- _Part 2_ will address [What?]{.speech}
